...
<script setup>
import { 
  Reading, Tools, Bell, ChatDotRound, Calendar, 
  QuestionFilled, ArrowDown, ArrowLeft, ArrowRight,
  Document, Service
...
const navItems = [
  ...
  { key: 'oj', label: 'OJ', icon: Tools },
  { key: 'calendar', label: '日历', icon: Calendar },
  { key: 'notifications', label: '通知', icon: Bell },
  { key: 'help', label: '帮助', icon: QuestionFilled },
  { key: 'ai', label: 'AI助手', icon: ChatDotRound }
]
...
const navigateToCoursePage = (pageKey) => {
  ...
  const routeMap = {
    ...
    ai: `/student/course/${currentCourseId.value}/ai`
  }
...
watch(() => route.path, (newPath) => {
  if (newPath.includes('/student/course')) {
    activeNav.value = 'courses'
  } else if (newPath.includes('/student/oj')) {
    activeNav.value = 'oj'
  } else if (newPath.includes('/student/calendar')) {
    activeNav.value = 'calendar'
  } else if (newPath.includes('/student/notifications')) {
    activeNav.value = 'notifications'
  } else if (newPath.includes('/student/help')) {
    activeNav.value = 'help'
  } else if (newPath.includes('/student/ai')) {
    activeNav.value = 'ai'
  }
}, { immediate: true })
